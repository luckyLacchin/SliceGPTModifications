...
# Copyright 2024 Google LLC and the HuggingFace Inc. team. All rights reserved.
...
class Gemma2ModelAdapter(ModelAdapter):
    ...
    def post_init(self, tokenizer: PreTrainedTokenizerBase) -> None:
        # Gemma2 may not have a pad token by default
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if "gemma-2-" not in model_name.lower():
            return None
